  ...
  def test_statusz_endpoint
    ...
    d.run do
      ...
      must_match = [
        ...
        '<tr><th>adjust_invalid_timestamps</th><td>false</td></tr>',
        '<tr><th>autoformat_stackdriver_trace</th><td>false</td></tr>',
        '<tr><th>coerce_to_utf8</th><td>false</td></tr>',
        '<tr><th>detect_json</th><td>true</td></tr>',
        '<tr><th>detect_subservice</th><td>false</td></tr>',
        '<tr><th>enable_metadata_agent</th><td>true</td></tr>',
        '<tr><th>enable_monitoring</th><td>true</td></tr>',
        '<tr><th>http_request_key</th><td>test_http_request_key</td></tr>',
        '<tr><th>insert_id_key</th><td>test_insert_id_key</td></tr>',
        '<tr><th>k8s_cluster_location</th><td>test-k8s-cluster-location</td></tr>',
        '<tr><th>k8s_cluster_name</th><td>test-k8s-cluster-name</td></tr>',
        '<tr><th>kubernetes_tag_regexp</th><td>.*test-regexp.*</td></tr>',
        '<tr><th>label_map</th><td>{\"label_map_key\"=>\"label_map_value\"}</td></tr>',
        '<tr><th>labels_key</th><td>test_labels_key</td></tr>',
        '<tr><th>labels</th><td>{\"labels_key\"=>\"labels_value\"}</td></tr>',
        '<tr><th>logging_api_url</th><td>http://localhost:52000</td></tr>',
        '<tr><th>metadata_agent_url</th><td>http://localhost:12345</td></tr>',
        '<tr><th>monitoring_type</th><td>not_prometheus</td></tr>',
        '<tr><th>non_utf8_replacement_string</th><td>zzz</td></tr>',
        '<tr><th>operation_key</th><td>test_operation_key</td></tr>',
        '<tr><th>partial_success</th><td>false</td></tr>',
        '<tr><th>project_id</th><td>test-project-id-123</td></tr>',
        '<tr><th>require_valid_tags</th><td>true</td></tr>',
        '<tr><th>source_location_key</th><td>test_source_location_key</td></tr>',
        '<tr><th>span_id_key</th><td>test_span_id_key</td></tr>',
        '<tr><th>split_logs_by_tag</th><td>true</td></tr>',
        '<tr><th>statusz_port</th><td>5678</td></tr>',
        '<tr><th>subservice_name</th><td>test_subservice_name</td></tr>',
        '<tr><th>trace_key</th><td>test_trace_key</td></tr>',
        '<tr><th>trace_sampled_key</th><td>test_trace_sampled_key</td></tr>',
        '<tr><th>use_aws_availability_zone</th><td>false</td></tr>',
        '<tr><th>use_grpc</th><td>true</td></tr>',
        '<tr><th>use_metadata_service</th><td>false</td></tr>',
        '<tr><th>vm_id</th><td>12345</td></tr>',
        '<tr><th>vm_name</th><td>test.hostname.org</td></tr>',
        '<tr><th>zone</th><td>asia-east2</td></tr>',
